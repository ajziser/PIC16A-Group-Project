...
9. Finally, run line 18 of the demo file code to create a decision tree with penguins data. It will print two values, the training score and the test data score for the model. This model uses a max depth of 2 to avoid overfitting or underfitting, but you can modify the mex depth in the CurrentCode file to see how the accuracy scores change with a different depth of decision tree. 
