...
This plot shows us the correlation between Delta 15 N (o/oo) and the penguin Species. Chinstrap Penguins generally had a higher Delta 15 N value, and Gentoo penguins had a lower value. You can run this line of code with different column names to see other correlations between the penguins data.
